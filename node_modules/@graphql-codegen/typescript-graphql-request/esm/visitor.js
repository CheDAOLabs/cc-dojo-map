    ...
    get sdkContent() {
        ...
        const allPossibleActions = this._operationsToInclude
            ...
            if (this.config.rawRequest) {
                ...
                return `${operationName}(variables${optionalVariables ? '?' : ''}: ${o.operationVariablesTypes}, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: ${o.operationResultType}; extensions?: ${this.config.extensionsType}; headers: Dom.Headers; status: number; }> {
