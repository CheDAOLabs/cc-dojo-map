...
const InternalMenu = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  ...
  const [wrapCSSVar, hashId] = (0, _style.default)(prefixCls, rootCls, !override);
  ...
  return wrapCSSVar( /*#__PURE__*/React.createElement(_OverrideContext.default.Provider, {
    ...
    ref: ref,
    rootClassName: (0, _classnames.default)(rootClassName, hashId, overrideObj.rootClassName, rootCls)
  }), mergedChildren))));
});
