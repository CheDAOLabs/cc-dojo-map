...
function generateRangePicker(generateConfig) {
  const RangePicker = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
    ...
    const cssVarCls = (0, _useCSSVarCls.default)(prefixCls);
    const [wrapCSSVar, hashId] = (0, _style.default)(prefixCls, cssVarCls);
    ...
    return wrapCSSVar( /*#__PURE__*/React.createElement(_rcPicker.RangePicker, Object.assign({
      ...
      }, (0, _statusUtils.getStatusClassNames)(prefixCls, (0, _statusUtils.getMergedStatus)(contextStatus, customStatus), hasFeedback), hashId, compactItemClassnames, className, rangePicker === null || rangePicker === void 0 ? void 0 : rangePicker.className, cssVarCls, rootClassName),
      ...
      direction: direction,
      dropdownClassName: (0, _classnames.default)(hashId, popupClassName || dropdownClassName, cssVarCls, rootClassName),
