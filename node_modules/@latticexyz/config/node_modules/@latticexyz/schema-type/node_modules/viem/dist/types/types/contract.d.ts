...
import type { Filter, IsNarrowable, MaybeRequired, NoUndefined, Prettify } from './utils.js';
...
export type GetEventArgsFromTopics<TAbi extends Abi | readonly unknown[], TEventName extends string, TTopics extends LogTopic[], TData extends Hex | undefined, TStrict extends boolean = true, TAbiEvent extends AbiEvent & {
    type: 'event';
} = TAbi extends Abi ? ExtractAbiEvent<TAbi, TEventName> : AbiEvent & {
    type: 'event';
    ...
    IndexedOnly: false;
    Required: TStrict;
}>> = TTopics extends readonly [] ? TData extends undefined ? {
    args?: never;
} : {
    args?: TArgs;
} : {
